 ...
 * <ul>
 *   <li>{@link robot.dsl.impl.DeviceImpl#getName <em>Name</em>}</li>
 *   <li>{@link robot.dsl.impl.DeviceImpl#getRefFonction <em>Ref Fonction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeviceImpl extends MinimalEObjectImpl.Container implements Device
{
  ...
  {
    return DslPackage.Literals.DEVICE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.DEVICE__NAME, oldName, name));
  }
  ...
  public EList<Fonctionnalite> getRefFonction()
  {
    if (refFonction == null)
    {
      refFonction = new EObjectContainmentEList<Fonctionnalite>(Fonctionnalite.class, this, DslPackage.DEVICE__REF_FONCTION);
    }
    return refFonction;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.DEVICE__REF_FONCTION:
